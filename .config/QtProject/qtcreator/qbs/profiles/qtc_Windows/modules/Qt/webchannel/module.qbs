...
QtModule {
    ...
    staticLibsRelease: []
    dynamicLibsDebug: []
    dynamicLibsRelease: ["/usr/lib/libQt5Qml.so.5.4.1", "/usr/lib/libQt5Network.so.5.4.1", "/usr/lib/libQt5Core.so.5.4.1", "pthread"]
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: []
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/usr/lib/libQt5WebChannel.so.5.4.1"
